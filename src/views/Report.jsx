...
class Report extends React.Component {
  ...
  chartdata = date_format => {
    ...
    axios
      .post("http://192.168.16.50:3000/api/v1/checkouttime", startDate)
      .then(res3 => {
        const response3 = res3.data.Data;
        console.log(response3);
        let chartdatab = [];
        response3.map((item, key) =>  {
          chartdatab.push(item.count);
        });
        this.setState({ chartdatab: chartdatab });
        ...
        <div className="content">
          ...
          {this.state.showGraph === true && (
            <ReportGraph
              ...
              chartdatab={this.state.chartdatab}
            />
          )}
        </div>
      </>
